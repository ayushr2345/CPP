...
namespace handlers
{
    ...
    void Handle(linkedList::LinkedListMain& linkedListMainObj)
    {
        ...
        while (linkedListMainObj.GetChoice())
        {
            ...
            case 4:
            {
                linkedListMainObj.CircularDoublyLinkedList();
                break;
            }
            case 5:
            {
    ...
    void Handle(queue::QueueMain& queueMainObj)
    {
        ...
        while (queueMainObj.GetChoice())
        {
            ...
            case 6:
            {
                queueMainObj.PriorityQueueElement();
                break;
            }
            case 7:
            {
                queueMainObj.QueueUsingTwoStacks();
                break;
            }
            case 8:
            {
    ...
    void Handle(sorting_algorithms::SortingAlgorithmsMain& sortingAlgorithmsMainObj)
    {
        ...
        while (sortingAlgorithmsMainObj.GetChoice())
        {
            ...
            case 2:
            {
                sortingAlgorithmsMainObj.InsertionSort();
                break;
            }
            case 3:
            {
            ...
            case 4:
            {
                sortingAlgorithmsMainObj.HeapSort();
                break;
            }
            case 5:
            {
